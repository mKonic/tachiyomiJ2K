...
import eu.mkonic.tachiyomi.databinding.LibraryControllerBinding
import eu.mkonic.tachiyomi.source.LocalSource
import eu.mkonic.tachiyomi.ui.base.MaterialMenuSheet
import eu.mkonic.tachiyomi.ui.base.MiniSearchView
...
import eu.mkonic.tachiyomi.ui.category.ManageCategoryDialog
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.BY_AUTHOR
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.BY_DEFAULT
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.BY_LANGUAGE
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.BY_SOURCE
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.BY_STATUS
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.BY_TAG
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.BY_TRACK_STATUS
import eu.mkonic.tachiyomi.ui.library.LibraryGroup.UNGROUPED
...
import eu.mkonic.tachiyomi.ui.main.BottomSheetController
import eu.mkonic.tachiyomi.ui.main.FloatingSearchInterface
import eu.mkonic.tachiyomi.ui.main.MainActivity
import eu.mkonic.tachiyomi.ui.main.RootSearchInterface
import eu.mkonic.tachiyomi.ui.manga.MangaDetailsController
import eu.mkonic.tachiyomi.ui.migration.manga.design.PreMigrationController
...
import eu.mkonic.tachiyomi.util.moveCategories
...
import eu.mkonic.tachiyomi.util.system.getResourceDrawable
import eu.mkonic.tachiyomi.util.system.ignoredSystemInsets
import eu.mkonic.tachiyomi.util.system.isImeVisible
...
import eu.mkonic.tachiyomi.util.view.isSettling

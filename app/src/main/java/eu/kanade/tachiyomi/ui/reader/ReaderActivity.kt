...
import eu.mkonic.tachiyomi.databinding.ReaderActivityBinding
...
import eu.mkonic.tachiyomi.ui.reader.ReaderViewModel.SetAsCoverResult.AddToLibraryFirst
import eu.mkonic.tachiyomi.ui.reader.ReaderViewModel.SetAsCoverResult.Error
import eu.mkonic.tachiyomi.ui.reader.ReaderViewModel.SetAsCoverResult.Success
...
import eu.mkonic.tachiyomi.ui.reader.settings.TabbedReaderSettingsSheet
import eu.mkonic.tachiyomi.ui.reader.viewer.BaseViewer
import eu.mkonic.tachiyomi.ui.reader.viewer.pager.L2RPagerViewer
import eu.mkonic.tachiyomi.ui.reader.viewer.pager.PagerViewer
import eu.mkonic.tachiyomi.ui.reader.viewer.pager.R2LPagerViewer
import eu.mkonic.tachiyomi.ui.reader.viewer.pager.VerticalPagerViewer
import eu.mkonic.tachiyomi.ui.reader.viewer.webtoon.WebtoonViewer
...
import eu.mkonic.tachiyomi.util.system.getBottomGestureInsets
...
import eu.mkonic.tachiyomi.util.system.launchNonCancellable
...
import eu.mkonic.tachiyomi.util.view.popupMenu
import eu.mkonic.tachiyomi.util.view.snack
import eu.mkonic.tachiyomi.widget.doOnEnd
import eu.mkonic.tachiyomi.widget.doOnStart
